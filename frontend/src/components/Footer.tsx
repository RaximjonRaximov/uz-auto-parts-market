...
export function Footer() {
  return (
    <footer className="border-t border-[var(--border)] bg-white/60 backdrop-blur-xl">
      <div className="container-main py-14">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
          <div className="md:col-span-2 space-y-4">
            <div className="flex items-center gap-3 group">
              ...
              <div>
                <div className="text-lg font-black text-[var(--foreground)] leading-none">UZ Auto Parts</div>
                <div className="text-[10px] font-extrabold uppercase tracking-widest text-[var(--primary)]">Marketplace</div>
              </div>
            </div>
            <p className="text-[var(--foreground)]/70 font-medium max-w-sm leading-relaxed">
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2.5 text-sm font-semibold text-[var(--foreground)]/70">
              <li><a href="#top" className="hover:text-[var(--primary)] transition-colors link-underline">Bosh sahifa</a></li>
              <li><a href="#categories" className="hover:text-[var(--primary)] transition-colors link-underline">Kategoriyalar</a></li>
              <li><a href="#listings" className="hover:text-[var(--primary)] transition-colors link-underline">E'lonlar</a></li>
              <li><a href="#stats" className="hover:text-[var(--primary)] transition-colors link-underline">Statistika</a></li>
            </ul>
          </div>
        ...
        <div className="pt-8 border-t border-[var(--border)] flex flex-col md:flex-row items-center justify-between gap-4 text-sm font-bold text-[var(--foreground)]/60">
          ...
          <div className="flex items-center gap-6">
            <span className="pill bg-[var(--muted)]">Demo ma'lumotlar bilan</span>
            <span className="pill bg-[var(--muted)]">AI ishlatilmagan</span>
          </div>
        </div>
      </div>
    </footer>
