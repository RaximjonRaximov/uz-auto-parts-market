    ...
    <header className="sticky top-0 z-40 glass border-b border-white/50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="text-lg font-extrabold text-gradient leading-none">UZ Auto Parts</div>
            <div className="text-[10px] font-bold uppercase tracking-widest text-slate-500">Marketplace</div>
          </div>
        </div>
